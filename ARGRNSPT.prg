...
poff = ''
      ...
      pndrv = ARGRNS->shipname
      pdid = ARGRNS->ashipname
      pdtel = ARGRNS->purtname
  ...
  *?
  ...
  if .not. plhd
   ? fgcoy->name  AT 3 STYLE "B"
     ? fgcoy->street  AT 3 , "INVOICE (Debit For Stock Loss)"  AT 41 STYLE 2
  ? fgcoy->address at 3
  ? 'Phone: '+fgcoy->phone at 3, 'Inv No.:' AT 41, ltrim(PDOC+ARGRNS->ORDER_NO)  AT 49
  ? left(fgcoy->country,3)+":"+FGCOY->PIN+" VAT:"+FGCOY->VAT AT 3,;
   'Date  .:' AT 41, ARGRNS->dde_date AT 49,   ARGRNS->DDE_TIME AT 62,ARGRNS->shiftno+ARGRNS->shiftid at 73
 ?  
 * * ? "-----------------------------------------------------------------------------------------------" at 1
*   ?
 *    ? 
 ? 'TO (CUSTOMER): '+FRIGHTER->SOURCE+FRIGHTER->FTYP+FRIGHTER->PMOD+FRIGHTER->FRIGHTER_N+" -- "+FRIGHTER->NAME AT 3 STYLE "B"
  *?
   
     ?"P.O. No:" AT 3, ARGRNS->ORDER AT 12, "Veh. No:" AT 31, ARGRNS->REG AT 41, "INV:" at 61, ARGRNS->PO_INV at 67
   *  ?
  ? 
*?  
...
ELSE  
      **
       ? "INVOICE"  AT 40 STYLE 2
    ? "Inv. No:" AT 54, ltrim(PDOC+ARGRNS->ORDER_NO)  AT 62
    ? "Date   :" AT 54, ARGRNS->dde_date AT 62, LEFT(ARGRNS->DDE_TIME,5) AT 73
    ? "LPO No :" AT 54, ARGRNS->ORDER AT 62
    ? "Veh. No:" AT 54, ARGRNS->REG AT 62 STYLE "B"
 
 **
      ?  "SHIFT NO. :"+ARGRNS->shiftno+ARGRNS->shiftid at 34 STYLE "B", "PO INV :" at 54, ARGRNS->PO_INV at 62
  ? FRIGHTER->SOURCE+FRIGHTER->FTYP+FRIGHTER->PMOD+FRIGHTER->FRIGHTER_N+" -- "+FRIGHTER->NAME AT 3 STYLE "B"
 *    ? LEFT(UPPER(ARGRNS->CUSTOMER),20)  AT 3 STYLE "B"
    ? "-----------------------------------------------------------------------------" AT 1 STYLE "B"
  ? "NO." AT 1 STYLE "B", "QTY" AT 12 STYLE "B", "ITEM DESCRIPTION" AT 17 STYLE "B",  "%VAT" AT 44 STYLE "B",;
   " PRICE " AT 57 STYLE "B", " TOTAL " AT 71 STYLE "B"
 ? "-----------------------------------------------------------------------------" AT 1 STYLE "B"
* ? "---" AT 1 STYLE "B", "---" AT 12 STYLE "B", "----------------" AT 17 STYLE "B",  "----" AT 44 STYLE "B",;
   "-------" AT 57 STYLE "B", "-------" AT 71 STYLE "B"
...
select ARGRLINE
   ...
   ? LTRIM(STR(PCNT)) PICTURE "99" AT 2, QTY PICTURE "99999.99" at 5, LEFT(FGCOD->NAME,28) AT 15,;
...
? "---------------" AT 63 
? "TOTAL DUE " AT 50 STYLE "B", PAMT PICTURE "9999,999,999.99" AT 63 STYLE "B"
? "===============" AT 63 
? "User/Cashier:" at 3, pluser+" / "+POFF AT 19
? "Served by   :" at 3, pdriver at 19,
? 'Driver      :' AT 3, PNDRV AT 19, 'Id:' at 35,pdid at 40, 'Phone:' at 53, pdtel at 61
?
